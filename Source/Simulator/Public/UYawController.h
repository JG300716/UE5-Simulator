...
#include "UYawController.generated.h"
...
public:
	...
	TiltLimits(float pitchForward, float pitchBackward, float roll) : pitchForward(pitchForward), pitchBackward(pitchBackward), roll(roll){};
};
